		...
		<form action="#" method="post" enctype="multipart/form-data" class="">
			...
			<div class="col-lg-6">
				...
				<div class="form-group">
					...
					<input type="text" name="fullname" id="fullname" value="<?php echo $fullname?>" class="form-control" required="required" placeholder="<?php echo __("Full name")?>" disabled="disabled">
				</div>
