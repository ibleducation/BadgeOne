...
<div id="main">
	...
	<div id='bread'><a href='/'><?php echo __("Home")?></a> > <?php echo __("View Badge Issuer")?></div>
	<div class='page_header'><?php echo __("View Badge Issuer")?></div>
	...
	<div class="container">
		...
		<div class="col-lg-7">
			...
			<div class="col-lg-12">
				...
				<div>
					<p><?php echo __("Course")?>: <strong><?php echo $course?></strong></p>
				...
				<?php if ( $user_profile !='general' ) { ?>
					...
					<?php if ($get_auth_client_id!='' && $get_auth_secret_key!='') { ?>
						<div class="form-group">
							<label><?php echo __("This Badge provider user-key")?> (<?php echo __("user")?>)</label>
							<p class="alert alert-warning"><?php echo $get_auth_client_id?></p>
						</div>
						<div class="form-group">
							<label><?php echo __("This Badge provider account secret-key")?> (<?php echo __("password")?>)</label>
							<p class="alert alert-warning"><?php echo $get_auth_secret_key?></p>
						</div>
						<div class="form-group">
							<label><?php echo __("This Badge ID")?></label>
