...
<div id="main">
    ...
    <div id='bread'><a href='/'><?php echo __("Home")?></a> > <?php echo __("Badges revoked")?></div>
    <div class='page_header'><?php echo __("Badges revoked")?></div>
    ...
    <div class="col-lg-12 col-md-12">
    	<div class="pull-left">
			...
			<div class="form-group"><label for="k_user"><?php echo __("Find user")?></label>
				<input type="text" class="form-control" name="k_user" id="k_user" placeholder="<?php echo __("name or email")?>" required="required" value="<?php echo $k_search_user ?>">
			</div>
	...
	<table class="table table-condensed">
		...
		<?php } } else { ?>
			<tr><td colspan="6" class="alert alert-danger"><?php echo __("Nothing found")?></td></tr>
		<?php } ?>
		</tbody>
	</table>
	<!-- /contents -->
